  ...
  var C = ["top", "bottom", "right", "left"], N = C.reduce((function (e, t) {
    ...
    X = {passive: !0}, Y = {
        ...
        if (e = e.name, !t.modifiersData[e]._skip) {
          ...
          var d = [n].concat(i).reduce((function (e, n) {
            return e.concat("auto" === x(n) ? function (e, t) {
              void 0 === t && (t = {});
              var n = t.boundary, o = t.rootBoundary, r = t.padding, i = t.flipVariations, a = t.allowedAutoPlacements,
                s = void 0 === a ? V : a, f = t.placement.split("-")[1];
      ...
      name: "preventOverflow", enabled: !0, phase: "main", fn: function (e) {
        ...
        if (s = {x: 0, y: 0}, a) {
          if (r || i) {
            var v = "y" === l ? "top" : "left", g = "y" === l ? "bottom" : "right", b = "y" === l ? "height" : "width",
              w = a[l], O = a[l] + f[v], j = a[l] - f[g], E = o ? -m[b] / 2 : 0, D = "start" === p ? u[b] : m[b];
